      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: 'linear-gradient(145deg, hsl(var(--primary)/0.05), hsl(var(--primary)/0))',
            border: '1px solid hsl(var(--primary)/0.18)',
            boxShadow: '0 0 0 1px hsl(var(--primary)/0.05), 0 8px 22px -10px hsl(var(--primary)/0.25)',
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            left: i % 2 === 0 ? '8%' : 'auto',
            right: i % 2 === 1 ? '8%' : 'auto',
            background: 'linear-gradient(90deg, rgba(255,255,255,0), hsl(var(--primary)/0.35) 40%, hsl(var(--primary)/0.15) 60%, rgba(255,255,255,0))',
      ...
      {[...Array(5)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, hsl(var(--primary)/0.15), hsl(var(--primary)/0))',
          }}
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                background: 'radial-gradient(circle at 35% 35%, hsl(var(--primary)/0.25), hsl(var(--primary)/0.08) 55%, hsl(var(--primary)/0) 70%)',
                border: '1px solid hsl(var(--primary)/0.15)',
                boxShadow: '0 0 40px -10px hsl(var(--primary)/0.20), inset 0 0 60px -25px hsl(var(--primary)/0.35)',
                mixBlendMode: 'plus-lighter',
                filter: 'blur(6px)',
              }}
              initial={{
              ...
              animate={{
                ...
                opacity: [0, 0.10 + (1 - depth) * 0.18, 0],
                y: [0, -60 + depth * 40, 0],
                filter: ['blur(10px)', 'blur(2.5px)', 'blur(10px)'],
              }}
              transition={{
